...
$container['strips'] = function($c) use ($settings) {
	$stripsSettings = [
		'base_dir' => __DIR__,
		'fields' => [
			'picture_type' => 'type',
		...
		'folders' => [
			'picture' => [
				'storage' => 'strips',
				'public' => 'strips_public',
			],
			'thumb' => [
				'storage' => 'strips_thumbs',
				'public' => 'strips_thumbs_public',
			],
		],
		'thumb_height' => $settings['strips']['thumb_height'],
	];

	return new \Plasticode\Gallery\Comics($c, $stripsSettings);
};
